...
::: {.fragment}
::: {style="font-size: 125%;"}
***[Data matters, and how you represent it matters, too.]{.highlight-orange}***
:::
:::
:::
:::
...
::: {.notes}
-	Also, pink? For women? Groundbreaking. Did this graph also cost 7% more to produce?
...
PLACEHOLDER: Form vs. Function, Exploratory vs. Explanatory
...
::: {.notes}
- A perceptive audience will poke holes in visuals that don’t add up, whether they skew, exaggerate, omit, or otherwise misrepresent the data
- Unless you’re a very confident and adept liar, you do NOT want to be put in this position
- Don't focus on appeasing stakeholders or advancing an agenda.
- Without the complete picture, we can’t make data-driven decisions like informed strategic pivots, and this ultimately hampers progress and works against organizational goals.
:::
